import type { GetCustomersResponseDto, GetOrderListDto } from '@siikli/shared'
...
beforeEach(() => {
  mockedAxios.get.mockImplementation((url) => {
    if (url === '/orders') {
      return Promise.resolve({ data: [{ id: '1', deliveryDate: '2021-01-01', orderNumber: 1, status: OrderStatus.WAITING_FOR_DELIVERY, customer: { id: '1', name: 'John Doe' }, total: '100' }] satisfies GetOrderListDto[] })
    }
    if (url === '/customers') {
