/*
  ...
  - You are about to drop the column `invoice_swift_bic` on the `tenant` table. All the data in the column will be lost.
  - You are about to drop the column `invoice_swift_bic` on the `tenant_history` table. All the data in the column will be lost.

*/
-- AlterTable
ALTER TABLE "tenant" DROP COLUMN "invoice_swift_bic";

-- AlterTable
ALTER TABLE "tenant_history" DROP COLUMN "invoice_swift_bic";
